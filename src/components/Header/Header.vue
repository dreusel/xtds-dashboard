<template>
	<v-app-bar
		...
		<v-toolbar-title>xTDS Power Dashboard</v-toolbar-title>
		<v-spacer></v-spacer>
		<Search />
		...
		<v-menu
			...
			<template v-slot:activator="{ on, attrs }">
				<v-btn
					...
					class="mr-2">
					<v-badge
						:value="notificationsBadge && notifications.length"
						color="error"
		...
		<v-menu
			...
			<template v-slot:activator="{ on, attrs }">
				<v-btn
					...
					class="mr-2">
					<v-badge
						:value="messageBadge && messages.length"
						color="warning"
			...
			<v-list>
				...
				<div class="subtitle-2 error--text font-weight-regular px-4 pb-2 link-item">{{ messages.length }} new Messages</div>
				<v-list-item-group color="primary">
					<v-list-item
		...
		<v-menu
			...
			<v-list >
				<div class="text-h5 grey--text text--darken-3 px-4 pt-4">xTDS User</div>
				<v-list-item-group color="primary">
					<v-list-item
